...
protected:
    ...
    std::vector<IGES_ENTITY_142*>vPTI;  // convenience for passing data via DLL
...
public:
     ...
     */
    int GetNPTI( void );
    IGES_ENTITY_142* GetPTI( int aIndex );
    bool GetPTIList( size_t& aListSize, IGES_ENTITY_142**& aPTIList );
